...
class BinaryTree
{
    ...
    /*Given a binary tree, print out all of its root-to-leaf
      ...
      the work.*/
    int printPaths(Node node)
    {
        int path[] = new int[1000];
        return printPathsRecur(node, path, 0);
    }
    ...
    int printPathsRecur(Node node, int path[], int pathLen)
    {
        if (node == null)
            return 0;
    ...
    public static void main(String args[])
    {
        ...
        System.out.println(tree.printPaths(tree.root.left.right));
    }
}
